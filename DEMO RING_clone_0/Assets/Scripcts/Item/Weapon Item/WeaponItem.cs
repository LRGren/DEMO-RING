...
public class WeaponItem : EquipmentItem
{
    ...
    public float jump_Light_Attack_01_Modifier = 1.2f;
    public float jump_Heavy_Attack_01_Modifier = 1.8f;
    ...
    public float jumpLightAttackStaminaModifier = 1.0f;
    public float jumpHeavyAttackStaminaModifier = 1.5f;
