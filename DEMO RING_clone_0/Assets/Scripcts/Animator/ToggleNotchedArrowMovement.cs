...
public class ToggleNotchedArrowMovement : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        player.characterLocomotionManager.canMove = allowMovement;
        player.characterLocomotionManager.canRotate = allowMovement;
        player.characterLocomotionManager.canRun = !allowMovement;
