...
public class AIBOSS01CharacterManager : AIBossCharacterManager
{
    ...
    public AIBOSS01SoundFXManager aiBOSS01SoundFXManager;

    override protected void Awake()
    {
        base.Awake();

        aiBOSS01SoundFXManager = GetComponent<AIBOSS01SoundFXManager>();
    }
}
